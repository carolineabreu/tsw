const countries = [
  {
    ...
    infos: {
      about:
        "Ireland, or the Republic of Ireland, is in north-western Europe, occupying most of the island of Ireland.",
      facts: [
    ...
    tips: {
      topCities: ["Cork - 70/100", "Cobh - 69/100", "Dublin - 68/100"],
      activities: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Iceland is a Nordic Island founded during the Viking age and is one of the most active volcanic regions in the world.",
      facts: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Sweden, Kingdom of Sweden, is the most extensive Nordic Country. Half of the country is covered with vast forests and has over 200,000 islands.",
      facts: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Canada is the second largest country in the world in the area,  but it's one of the countries with less population density.",
      facts: [
    ...
    tips: {
      topCities: ["Victoria - 79/100", "Quebec - 74/100", "Vancouver - 73/100"],
      activities: ["Niagara Falls", "Banff National Park", "Butchart Gardens"],
  ...
  },
  {
    ...
    infos: {
      about:
        "Switzerland, officially the Swiss Confederation, is a landlocked mountainous country with several miles of glacier alps, lakes, and valleys.",
      facts: [
    ...
    tips: {
      topCities: ["Geneva - 87/100", "Bern - 80/100", "Zurich - 78/100"],
  ...
  },
  {
    ...
    infos: {
      about:
        "South Korea, officially the Republic of Korea, is bordered by the Sea of Japan and the Yellow Sea. It's a highly developed country with one of the world's fastest Internet wireless speed.",
      facts: [
    ...
    tips: {
      topCities: ["Seoul - 65/100", "Busan - 61/100", "Bucheon - 61/100"],
      activities: ["DMZ (Demilitarized Zone)", "Yonggungsa Temple", "Everland"],
  ...
  },
  {
    ...
    infos: {
      about:
        "New Zealand is a remote, mountainous group of islands in the southwestern Pacific Ocean. Was the first country to give women the right to vote, and the first to introduce a minimum wage.",
      facts: [
  ...
  },
  {
    ...
    name: "Uruguay",
    images: [
      require("./images/Countries/uruguay-anderson-ROoqgQ3aF3k-unsplash.jpg"),
      require("./images/Countries/uruguay-jared-schwitzke-Y_J9VezlMPc-unsplash.jpg"),
      require("./images/Countries/uruguay-pedro-slinger-ehFgttlFJNA-unsplash.jpg"),
    ],
    infos: {
      about:
        "Uruguay, officially the Oriental Republic of Uruguay, is the second smallest country on the continent and one of the most socially progressive.",
      facts: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Japan is an archipelago with over four-fifths of the land consisting of mountains. It's a highly developed country with the world's highest life expectancy.",
      facts: [
    ...
    tips: {
      topCities: ["Kyoto - 71/100", "Tokyo - 65/100", "Okinawa - 60/100"],
  ...
  },
  {
    ...
    infos: {
      about:
        "The Netherlands, informally Holland, is a low-lying country with approximately a quarter of its territory below sea level. The country has a long tradition of social tolerance, being the first to legalize same-sex marriage.",
      facts: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Belgium is one of the smallest and most densely populated countries in Europe. It has a high-income economy and very high quality of life standards, categorized as very high on the Human Develop Index.",
      facts: [
    ...
    tips: {
      topCities: ["Brussels 79/100", "Bruges 74/100", "Ghent - 73/100"],
  ...
  },
  {
    ...
    infos: {
      about:
        "Austria is a landlocked country, and together with Switzerland, it forms the neutral core of Europe. Due to the Alp's highly mountainous terrain, only 30% of the country is below 500 metres.",
      facts: [
    ...
    tips: {
      topCities: ["Innsbruck - 81/100", "Salzburg - 80/100", "Vienna - 76/100"],
      activities: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Norway is a Nordic country, its shares the Scandinavian Peninsula with Sweden and Finland. It has the highest Human Development Index and one of the world's lowest crime rates.",
      facts: [
    ...
    tips: {
      topCities: ["Tromsø - 81/100", "Oslo - 78/100", "Bergen - 74/100"],
  ...
  },
  {
    ...
    infos: {
      about:
        "Spain, or the Kingdom of Spain, occupies about 85% of the Iberian Peninsula. Its health system is considered one of the most efficient worldwide, being a leader in organ transplant and donation.",
      facts: [
    ...
    tips: {
      topCities: ["Bilbao - 80/100", "Valencia - 77/100", "Barcelona - 75/100"],
      activities: [
  ...
  },
  {
    ...
    infos: {
      about:
        "Portugal, officially the Portuguese Republic, is the westernmost point in Europe. It's a country with an advanced economy and diverse industry and is known for its wine and olive oil production.",
      facts: [
    ...
    tips: {
      topCities: ["Porto - 81/100", "Lisbon - 78/100", "Coimbra - 72/100"],
      activities: [
        "Castelo dos Mouros",
